      ...
      <header className="border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          <div>
            ...
            <p className="text-sm text-zinc-500">Phase 1 — File Chunking</p>
          </div>
      ...
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col items-center px-6 py-12">
        <div className="mb-10 max-w-xl text-center">
          <h2 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">
            Upload a file to split into blocks
          </h2>
          <p className="mt-2 text-zinc-600 dark:text-zinc-400">
            Select any file to chunk it into fixed-size blocks and compute a
            SHA-256 hash. Check the browser console for detailed output.
          </p>
        </div>
